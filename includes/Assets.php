...
abstract class Assets {
	...
	public static function get_styles() {
		...
		return apply_filters( 'marko_shopper_weather_api_enqueue_styles', array() );
	}
	...
	public static function get_scripts() {
		...
		return apply_filters( 'marko_shopper_weather_api_enqueue_scripts', array() );
	}
	...
	public static function load_scripts() {
		...
		if ( ! did_action( 'before_marko_shopper_weather_api_init' ) ) {
			return;
		}
